...
# Dayne hack - only 1 stove
report_stoves = report_stoves[0::1]
...
year =  2019 # int(input('Enter the year of the reports: '))
month = 10  # int(input('Enter the month of the reports: '))
fuel_price = 3.03 # float(input('Current price of fuel: '))
