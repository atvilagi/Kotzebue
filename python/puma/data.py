...
def puma2uni_nc():
    ...
    air_temp_file = os.path.join(file_path,'..','..','data','netcdf','aoos_snotel_temp.nc')
    fuel_click_file = os.path.join(file_path,'..','..','data','text','FuelClickConversion.txt')
    
    new_nc = os.path.join(file_path,'..','..','data','netcdf','puma_unified_data.nc')
